...
describe('Campaign Service - Domain Logic', () => {
  ...
  describe('createCampaign', () => {
    ...
    it('should create campaign with valid name', () => {
      ...
      fileUtils.validateRequiredFiles.mockReturnValue({ valid: true, missingFiles: [] });

      const result = createCampaign('new-campaign');

      expect(fileUtils.createDirectory).toHaveBeenCalledWith('/test/path/new-campaign');
    ...
    it('should validate scaffold files after creation', () => {
      ...
      expect(() => createCampaign('new-campaign')).toThrow('Missing required files');
    });
  });
  ...
  describe('loadCampaignConfig', () => {
    ...
    it('should handle invalid config gracefully', () => {
      ...
      expect(() => loadCampaignConfig('test-campaign')).toThrow('Failed to load or validate config');
    });
  });
